...
async function main() {
  ...
  try {
    ...
    console.log('✓ 2 camps created\n');

    // Créer des personnes disparues
    console.log('👤 Creating missing persons...');
    const missing1 = await prisma.missingPerson.create({
      data: {
        personType: 'missing',
    ...
    const missing2 = await prisma.missingPerson.create({
      data: {
        personType: 'missing',
    ...
    console.log('✓ 2 missing persons created\n');

    // Créer des réfugiés
    console.log('🌍 Creating refugees...');
    const refugee1 = await prisma.missingPerson.create({
      data: {
        personType: 'refugee',
    ...
    const refugee2 = await prisma.missingPerson.create({
      data: {
        personType: 'refugee',
    ...
    console.log('✓ 2 refugees created\n');

    // Créer des déplacés internes
    console.log('📍 Creating internally displaced persons...');
    const displaced1 = await prisma.missingPerson.create({
      data: {
    ...
    const displaced2 = await prisma.missingPerson.create({
      data: {
        personType: 'displaced',
    ...
    console.log('✓ 2 internally displaced persons created\n');

    // Créer des membres de famille chercheurs
    console.log('👨‍👩‍👧 Creating family members...');
    const familyMember1 = await prisma.familyMember.create({
      data: {
    ...
    console.log('🔗 Creating family matches...');
    ...
    console.log('✓ 2 family matches created\n');
    ...
    console.log('✓ 2 sightings created\n');

    console.log('✅ Seed data created successfully!\n');
    console.log('📊 Summary:');
    console.log('  - 2 agents');
    console.log('  - 2 camps (1 refugee, 1 displaced)');
    console.log('  - 2 missing persons');
    console.log('  - 2 refugees');
    console.log('  - 2 internally displaced persons');
    console.log('  - 2 family members');
    console.log('  - 2 family matches');
    console.log('  - 2 sightings\n');
    console.log('🔐 Test credentials:');
    console.log('  Agent 1: agent1@natafuta.org / password123');
    console.log('  Agent 2: agent2@natafuta.org / password123\n');
  } catch (error) {
